...
\section{Molecular bonding\buch{9}}
...
\subsection{Ionic bonding\buch{14}}
...
\subsection{Covalent bonding\buch{11}} 
Atoms share electrons to fill their valence bands.

\subsection{Metallic bonding\buch{13}}
Atoms are held together by electron gas.

\subsection{Secondary (Van der Waals) bonding\buch{18}}
Weak force between polar molecules (dipoles, e.g. \ce{H2O}). 

\subsection{Comparison\buch{21}} ~\\
\begin{table}[ht]
...
\subsection{Crystal structures\buch{49}}
...
\begin{figure}[ht!]
    ...
    \end{subfigure}     
    \caption{Comparison of unit cells\buch{50--54}}
\end{figure}
...
\begin{table}[ht!]
    ...
    \bottomrule
    \end{tabularx}
    \caption{Properties of some important crystal structures\buch{54}}
\end{table}

\subsection{Allotropy and carbon\buch{61}}
Certain substances can have more than one crystal structure. 
E.g. carbon has eight allotropes: Diamond, Graphite, Lonsdaleite, \ce{C60} (buckyball), \ce{C540},  \ce{C70}, amorphous carbon and single-walled carbon nanotube.
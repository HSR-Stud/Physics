...
\begin{figure}[ht!]
    \centering
    \input{tikz/twohydrogenatoms.tex}
...
\begin{figure}[ht!]
    \centering
    \input{tikz/energylevelsplitting.tex}
    \caption{Energy level splitting in a \ce{H2} molecule}
\end{figure}
